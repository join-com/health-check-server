...
exports.createRequestHandler = (health, readiness, shutdownState) => (request, response) => {
...
exports.createHealthServer = ({ health, readiness }, shutdownState) => http.createServer(exports.createRequestHandler(health, readiness, shutdownState));
